...
urlpatterns = [
    ...
    path('PatientReg/',docviews.Patient_Reg,name='PatientReg'),
    path('Patient_home/', docviews.PATIENTHOME, name='patient_home'),
    ...
    path('newappoinment', userviews.newappoinment, name='newappoinment'),
